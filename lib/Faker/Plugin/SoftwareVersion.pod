...
Faker::Plugin::SoftwareVersion

=cut

=head1 ABSTRACT

Software Version Plugin for Faker
...
=head1 SYNOPSIS
  ...
  my $f = Faker->new;
  my $p = Faker::Plugin::SoftwareVersion->new(faker => $f);
...
This package provides methods for generating fake software version data.
...
The execute method returns a random fake software version.
