...
=head2 Internet_Port_Dynamic
  
  Internet_Port_Dynamic(HashRef $data) (Str)

The Internet_Port_Dynamic method returns a random dynamic port.

I<Since C<1.10>>

=over 4

=item Internet_Port_Dynamic example 1
  ...
  # my $Internet_Port_Dynamic = $faker->Internet_Port_Dynamic;
...
=head2 Internet_Port_Registered
  
  Internet_Port_Dynamic(HashRef $data) (Str)

The Internet_Port_Dynamic method returns a random registered port.

I<Since C<1.10>>

=over 4

=item Internet_Port_Registered example 1
  ...
  # my $Internet_Port_Registered = $faker->Internet_Port_Registered;
...
=head2 Internet_Port_WellKnown
  
  Internet_Port_WellKnown(HashRef $data) (Str)

The Internet_Port_WellKnown method returns a random well-known port.

I<Since C<1.10>>

=over 4

=item Internet_Port_WellKnown example 1
  ...
  # my $Internet_Port_WellKnown = $faker->Internet_Port_WellKnown;
...
=head2 Internet_Port
  ...
  Internet_Port(HashRef $data) (Str)

The Internet_Portn method returns a random ineternet port.

I<Since C<1.10>>

=over 4

=item Internet_Port example 1
  ...
  # my $Internet_Port = $faker->Internet_Port;
